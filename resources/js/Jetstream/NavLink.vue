...
<script>
    ...
    export default {
        ...
        computed: {
            classes() {
                return this.active
                    ? 'inline-flex items-center px-1 pt-1 border-b-2 border-lime-500 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-lime-700 transition'
