            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('test-suites.index')" :active="route().current('test-suites.*') || route().current('tests.*')">
                                    Test Suites
                                </JetNavLink>
                                <JetNavLink :href="route('runs.index')" :active="route().current('runs.*')">
                                    Run History
                                </JetNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('test-suites.index')" :active="route().current('test-suites.*') || route().current('tests.*')">
                            Test Suites
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('runs.index')" :active="route().current('runs.*')">
                            Run History
                        </JetResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                ...
                                <!-- Team Settings -->
                                <JetResponsiveNavLink :href="route('teams.show', $page.props.auth.user.current_team)" :active="route().current('teams.show')">
                                    Team Settings
                                </JetResponsiveNavLink>
