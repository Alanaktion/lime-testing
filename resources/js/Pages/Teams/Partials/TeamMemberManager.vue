                ...
                <template #form>
                    ...
                    <div class="col-span-6 lg:col-span-4" v-if="availableRoles.length > 0">
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                            <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-hidden focus:border-sky-300 focus:ring-3 focus:ring-sky-200"
                                ...
                                <div :class="{'opacity-50': addTeamMemberForm.role && addTeamMemberForm.role != role.key}">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <svg v-if="addTeamMemberForm.role == role.key" class="ml-2 h-5 w-5 text-lime-600" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    </div>
                        ...
                        <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-hidden focus:border-sky-300 focus:ring-3 focus:ring-sky-200"
                            ...
                            <div :class="{'opacity-50': updateRoleForm.role && updateRoleForm.role !== role.key}">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <svg v-if="updateRoleForm.role === role.key" class="ml-2 h-5 w-5 text-lime-600" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                </div>
